    ...
    <div>
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 tracking-tight" data-testid="text-dismantling-title">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-5 gap-12">
            <div className="lg:col-span-2">
              ...
              <h3 className="text-lg font-semibold text-accent mb-4">Strategic Decommissioning Solutions</h3>
            ...
            <div className="lg:col-span-3">
              <h2 className="text-2xl font-bold mb-6 tracking-tight">The Enterprise Dismantling Framework</h2>
              <div className="space-y-4">
                {steps.map((step, i) => (
                  <Card key={step.title} className="p-5 border-card-border">
      ...
      <section className="py-16 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl font-bold mb-4">Get a Dismantling Consultation</h2>
